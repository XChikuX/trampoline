...
mod tests {
    ...
    fn should_timeout() {
        ...
        let res = async_std::task::block_on(check_smtp(&to_email, &host, 25, "gmail.com", &input));
        match res {
    ...
    fn should_skip_domains() {
        ...
        let res = async_std::task::block_on(check_smtp(&to_email, &host, 25, "icloud.com", &input));
        match res {
